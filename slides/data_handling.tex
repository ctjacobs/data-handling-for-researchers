...
\frame{
   ...
   \begin{itemize}
    ...
    \item Download the files from the following web address to your repository's folder (Desktop/GitHub/data-handling-course): amcg.ese.ic.ac.uk/~ctj10/data-handling-course\vspace*{3mm}
