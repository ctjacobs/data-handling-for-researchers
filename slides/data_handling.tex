...
\frame{
   ...
   \begin{itemize}
    ...
    \item Can it be {\color{red}trusted}? (Is the author list available? Reputable journal?)
   \end{itemize}
}
...
\frame{
   \frametitle{Creating and manipulating data}
   \framesubtitle{Version control systems -- Git}
   \begin{itemize}
...
\frame{
   \frametitle{Exercise}
   \begin{itemize}
    \item Bitbucket offers unlimited free private repositories.
